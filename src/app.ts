...
import { authenticationRoutes, publicRoutes, privateRoutes } from './routes';
...
export class App {
    ...
    private routerConfig() {
        ...
        this.app.use('/api/v1/private', privateRoutes);
        this.app.use('/api/v1/authentication', authenticationRoutes);
    }
}